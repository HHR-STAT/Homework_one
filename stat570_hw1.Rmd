...
The estimated beta0 is `r fitlm$coefficients[1]`, estimated beta1 is `r fitlm$coefficient[2]`. The estimated equation is y = `r fitlm$coefficients[1,1]` + `r fitlm$coefficients[2,1]` $\times$ x The 95% confindence interval for beta1 is (`r summary$coefficients[1,2]`, `r summary$coefficients[2,2]`), which captures the true beta1. __The RSE is 1.825, which is reasonably close to 2.__
