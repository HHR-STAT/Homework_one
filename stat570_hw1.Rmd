...
dir <-  "/Users/Rui/Downloads/Homework_one-master 3/data/" # this should be the folder containing data.
setwd(dir)
...
knitr::include_graphics("Figs/us_sample.png")
```
...
The estimated beta0 is 0.6920, estimated beta1 is 1.8477. The estimated equation is `y = 0.6920 + 1.8477*x` The 95% confindence interval for beta1 is `(-0.3483492 4.043683)`, which captures the true beta1. The RSE is 1.825, which is reasonably close to 2.
